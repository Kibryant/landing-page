...
const Footer = () => {
    return (
        <footer className="w-full flex items-center justify-center py-4 px-2 bg-brandBlue">
            <div className="flex flex-col gap-6 w-full max-w-7xl">
                <div className="grid place-items-center grid-cols-4 w-full">
                    ...
                    <div className="flex flex-col justify-center gap-2">
                        ...
                        <div className="relative">
                            <input
                                className="w-full rounded-sm border p-2 bg-transparent outline-none text-white"
                                type="text"
                            />
                ...
                <div className="border-t py-2">
                    <p className="text-center  text-white text-xs font-medium">
                        Copyright 2021 Arthur's All Rights Reserved.
                    </p>
                </div>
            </div>
        </footer>
