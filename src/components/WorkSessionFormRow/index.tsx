...
import { createWorkSession, updateWorkSession } from '@/action'
...
const WorkSessionFormRow: React.FC<Props> = ({ account, session, onCancelClick }) => {
    ...
    return (
        <form ref={formRef} action={handleAction}>
            ...
            <div className="flex gap-2 border-b border-slate-200 py-3">
                <div className="flex-1 font-medium">
                    <Input
                        type="date"
                        name="startsOn"
                        defaultValue={session?.startsOn?.toISOString().substring(0, 10) || undefined}
                    />
                </div>
