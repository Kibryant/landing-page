                            ...
                            <div className="flex gap-1 justify-center">
                                {colorVariants.map((color, index) => (
                                    <Link
                                        ...
                                        key={color}
                                        className={`bg-white shadow px-4 py-1 rounded-full border-2 capitalize font-medium duration-200 ${selectedColor === color && 'border-brandBlue'
                                            }`}
                                    >
                                        {color}
                                    </Link>
                        ...
                        <div className="flex flex-col justify-start gap-2">
                            ...
                            {sizeVariants.map((size, index) => (
                                <Link
                                    ...
                                    key={size}
                                    className={`bg-white shadow px-4 py-1 rounded-full border-2 uppercase font-medium duration-300 ${selectedSize === size && 'border-brandBlue'
                                        }`}
                                >
                                    {size}
                                </Link>
