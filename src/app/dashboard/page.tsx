    ...
    return (
        <div>
            ...
            <main className="space-y-8">
                <Section>
                    <div className="flex flex-col items-center justify-center sm:gap-y-16 gap-y-4 w-full">
                        <div className="flex flex-col items-center gap-y-2">
                            <h1 className="text-5xl font-bold">
                                Codext My First <span className="text-primary">LP</span>
                            </h1>
                            <p className="sm:text-center max-w-lg">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, nam similique odit, aliquam
                                repudiandae saepe
                            </p>
                            <Button className="w-full max-w-md font-bold uppercase text-center text-secondary-foreground">
                                <Link href="/accounts/sign-up">Get started</Link>
                            </Button>
                        </div>

                        <div className="rounded-lg dark:bg-gray-200/5 dark:ring-gray-200/10 bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-10 lg:rounded-xl">
                            <Image
                                ...
                                className="rounded-lg sm:p-8 md:p-10 shadow-2xl ring-1 dark:ring-gray-200/10 ring-gray-900/10"
                            />
                        </div>
                    </div>
                </Section>
                <section className="relative flex flex-col sm:items-center sm:justify-center gap-y-4">
                    {/* <Image
                        alt="Cloud"
                        quality={100}
                        width={751.7}
                    ...
                    /> */}
                    <div className="flex flex-col sm:items-center gap-y-2">
                        <h1 className="text-5xl font-bold">
                    ...
                    <div className="flex w-full flex-col-reverse gap-y-4 sm:gap-y-0 sm:flex-row max-w-7xl sm:items-center justify-between">
                        <div className="rounded-lg ring-1 ring-inset lg:rounded-xl">
                            <Image
                                ...
                                className="hidden sm:block rounded-lg p-2 sm:p-8 md:p-10 shadow-2xl ring-1 dark:ring-gray-200/10 ring-gray-900/10"
                            />
                        </div>

                        <div className="flex flex-col gap-y-6 z-50">
                            <h2 className="text-3xl font-bold text-left">I&apos;ts a Very Beautiful System</h2>
